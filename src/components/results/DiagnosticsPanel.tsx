import type { DayOffAnalysis, LectureConflict } from '../../domain/analysis';
...
export default function DiagnosticsPanel({ solution, lectureConflicts, dayOffAnalysis, daysOff }: DiagnosticsPanelProps) {
